				...
				<div class="cart">
                    <table class="table table-responsive">
                        ...
                        <?php endfor; ?>
						  ...
						  <tr>
                            <th colspan="7" class="total-text">Bonus Points:</th>
					...
					if($spoint=="0") echo "0" ;
					else echo $spoint. ' = ' . LANG_VALUE_1 . ' ' . ceil($spoint/100) ;
					...
					?> 
                        ...
                        <tr>
                            <th colspan="7" class="total-text">Total - Bonus: </th>
                            <th class="total-amount"><?php echo LANG_VALUE_1; ?><?php echo $table_total_price - (ceil($spoint/100)); ?></th>
                            <th></th>
                        </tr>
                    </table> 
                </div>
